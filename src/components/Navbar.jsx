        ...
        <div className="container-x flex h-16 items-center gap-4">
          ...
          <div className={`relative ml-auto flex items-center transition-all duration-300 ${searchOpen ? "w-full max-w-md" : "w-44 sm:w-56"}`}>
            ...
            <input
              ...
              className="w-full rounded-full border border-charcoal/20 bg-mint-pale py-2.5 pl-10 pr-4 text-sm text-charcoal outline-none transition focus:border-forest focus:bg-white focus:ring-2 focus:ring-lime/50"
            />
            {searchOpen && query && (
