      ...
      <div className="bg-forest">
        <div className="container-x flex h-16 items-center gap-4">
          ...
          <button
            ...
            className="ml-1 flex items-center gap-2 rounded-full px-3 py-2 text-sm font-semibold text-white transition hover:bg-white/10"
          ...
          <div className={`relative ml-auto flex items-center transition-all duration-300 ${searchOpen ? "w-full max-w-md" : "w-44 sm:w-56"}`}>
            <svg className="pointer-events-none absolute left-3 text-forest-deep" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <input
              ...
              className="w-full rounded-full border border-white/30 bg-white py-2.5 pl-10 pr-4 text-sm text-charcoal outline-none transition focus:ring-2 focus:ring-lime"
            />
            {searchOpen && query && (
          ...
          <div className="hidden items-center gap-2 lg:flex">
            <button onClick={() => onAuth("register")} className="btn-outline-light !px-5 !py-2.5">Register</button>
            <button onClick={() => onAuth("login")} className="btn bg-lime text-forest-deep hover:bg-lime-glow !px-5 !py-2.5">Log in</button>
          </div>
        </div>
      </div>
